...
void IBus::getData(rc_msgs::IbusData* i_bus_cmd)
{
  if (is_update_)
  {
    ...
    i_bus_cmd->ch_l_x = static_cast<double>((i_bus_data_.ch[0] - 1500.0) / 500.0);
    i_bus_cmd->ch_l_y = static_cast<double>((i_bus_data_.ch[1] - 1500.0) / 500.0);
    i_bus_cmd->ch_r_y = static_cast<double>((i_bus_data_.ch[2] - 1500.0) / 500.0);
    i_bus_cmd->ch_r_x = static_cast<double>((i_bus_data_.ch[3] - 1500.0) / 500.0);
